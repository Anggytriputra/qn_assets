...
export default function DetailReturn({ detailData = [], img = {} }) {
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="-mx-4 mt-8 flex flex-col sm:-mx-6 md:mx-0">
        <table className="min-w-full divide-y divide-gray-300">
          ...
          {detailData.transD &&
            detailData.transD.length > 0 &&
            detailData.transD.map((transd, stockIdx) => (
              <tbody>
                <tr
                  key={transd.id}
